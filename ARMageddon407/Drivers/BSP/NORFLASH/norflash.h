...
#define SPI1_SCK_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB时钟使能 */

#define SPI1_MISO_GPIO_PORT             GPIOB
#define SPI1_MISO_GPIO_PIN              GPIO_PIN_4
#define SPI1_MISO_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB时钟使能 */

#define SPI1_MOSI_GPIO_PORT             GPIOB
#define SPI1_MOSI_GPIO_PIN              GPIO_PIN_5
#define SPI1_MOSI_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB时钟使能 */
...
/******************************************************************************************/
/* SPI1 DMA 定义 (STM32F407 DMA2) */

/* SPI1 RX DMA: DMA2 Stream 2 Channel 3 */
#define SPI1_RX_DMA_STREAM              DMA2_Stream2
#define SPI1_RX_DMA_CHANNEL             DMA_CHANNEL_3
#define SPI1_RX_DMA_CLK_ENABLE()        do{ __HAL_RCC_DMA2_CLK_ENABLE(); }while(0)
#define SPI1_RX_DMA_IRQn                DMA2_Stream2_IRQn
#define SPI1_RX_DMA_IRQHandler          DMA2_Stream2_IRQHandler

/* SPI1 TX DMA: DMA2 Stream 3 Channel 3 */
#define SPI1_TX_DMA_STREAM              DMA2_Stream3
#define SPI1_TX_DMA_CHANNEL             DMA_CHANNEL_3
#define SPI1_TX_DMA_CLK_ENABLE()        do{ __HAL_RCC_DMA2_CLK_ENABLE(); }while(0)
